                        ...
                        <div class="card-body">
                            <div class="table-responsive w-100" style="overflow:hidden;">
                                ...
                                <form class="form form-tambah-soal-<?php echo e($j10->kode_mentor_pelajaran); ?>"
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Jumlah soal<span
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Waktu mengerjakan<span
                                                class="text-danger">*</span></label>
                                        <span id="pesan_error_waktu" class="text-danger"></span>
                                        <br>
                                        <p class="font-italic text-grey">Masukkan Waktu, Tanggal mulai dan batas waktu
                                        </p>

                                        <div class="row">
                                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3"
                                                data-toggle="tooltip" data-placement="top" title="Tanggal mulai">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text bg-info text-white"> <i
                                            ...
                                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3"
                                                data-toggle="tooltip" data-placement="top" title="Jam mulai">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text bg-info text-white"> <i
                                            ...
                                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3"
                                                data-toggle="tooltip" data-placement="top" title="Tanggal selesai">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text bg-info text-white"> <i
                                            ...
                                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3"
                                                data-toggle="tooltip" data-placement="top" title="Jam selesai">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text bg-info text-white"> <i
                            ...
                            <div class="table-responsive w-100" style="overflow:hidden;">
                                ...
                                <form class="form form-tambah-soal-<?php echo e($j11->kode_mentor_pelajaran); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span id="pesan_error_waktu" class="text-danger"></span>
                                        <br>
                                        <p class="font-italic text-grey">Masukkan Waktu, Tanggal mulai dan batas
                                            waktu
                                        </p>
            ...
            <div class="modal-body">
                ...
                <form class="form form-update-judul" action="<?php echo e(route('mentor.question_update_title')); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <span id="pesan_error" class="text-danger"></span>
                        <input type="number" name="jumlah_soal_update" readonly class="form-control" min="5" max="20"
                            value="5" id="jumlah_soal">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3" data-toggle="tooltip"
                                data-placement="top" title="Tanggal mulai">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-info text-white"> <i
                                            class="fas fa-calendar-alt"></i></div>
                                </div>
                                <input type="date" name="tgl_mulai_update" class="form-control"
                                    placeholder="tanggal mulai" required>

                            </div>

                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3" data-toggle="tooltip"
                                data-placement="top" title="Jam mulai">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-info text-white"> <i class="fas fa-clock"></i></div>
                                </div>
                                <input type="text" name="jam_mulai_update" class="form-control clockpicker"
                                    data-placement="bottom" placeholder="waktu mulai" data-autoclose="true" readonly
                                    required>
                            </div>

                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3" data-toggle="tooltip"
                                data-placement="top" title="Tanggal selesai">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-info text-white"> <i
                                            class="fas fa-calendar-day"></i></div>
                                </div>
                                <input type="date" name="tanggal_selesai_update" class="form-control"
                                    placeholder="tanggal selesai" required>
                            </div>

                            <div class="input-group mb-2 col-xs-12 col-sm-6 col-md-3" data-toggle="tooltip"
                                data-placement="top" title="Jam selesai">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-info text-white"> <i class="fas fa-stopwatch"></i>
                                    </div>
                                </div>
                                <input type="text" name="jam_selesai_update" class="form-control clockpicker"
                                    data-placement="bottom" placeholder="waktu selesai" readonly data-autoclose="true"
                                    required>
                            </div>
                        </div>
                    </div>

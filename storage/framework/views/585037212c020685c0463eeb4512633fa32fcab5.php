...
<head>
  ...
  <title><?php echo e(config('app.name', 'Mozart')); ?> | Student</title>
  ...
  <link rel="stylesheet" href="<?php echo e(URL::to('bootstrap/dist/css/bootstrap.min.css')); ?>"
...
<body id="page-top">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <span
                class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e(Auth::guard('student')->user()->name); ?></span>
  ...
  $(".btn-kirim-email").click(function() {
      ...
      Swal.fire({
                title: 'Terkirim',
                html: "Email verifikasi telah dikirim ke alamat email <span class='text-danger'>" + email + "</span>!<br><br><small><i class='fas fa-exclamation-circle'></i> <span class='text-warning font-weight-bold'>Note: </span>Jika email verifikasi tidak muncul, cek folder spam anda.</small>",
                type: 'success',
...
</html><?php /**PATH /home/wahyu/Desktop/mozart-elearning/resources/views/student/layouts/app.blade.php ENDPATH**/ ?>
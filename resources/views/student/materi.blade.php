...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
            ...
            <div class="row ml-2">
                    ...
                    <div class="row overflow-auto"
                        ...
                        <div class="col-md-6 p-0">
                            ...
                            <div class="card m-2">
                                ...
                                <a href="javascript:void(0)" class="btn-mentor" data-mentor="{{ $m->id_mentor }}"><img
                                        class="rounded" src="{{ url('images/'.$m->foto) }}"
                ...
                <div class="col-lg-9">
                    <div class="text-center">
                        ...
                        {{-- <div class="row">
                            @for($i = 0; $i < 20; $i++) <div class="col-md-3" class="border: 2px solid grey;">
                                <a href="javascript:void(0)"><img class="rounded " src="{{ url('sample.jpg') }}"
                        style="width:100%;height:100%;"></a>
                    </div>
                    @endfor
                </div> --}}
        ...
        {{-- @foreach ($std as $m)
                        ...
                        <a href="{{ route('student.daftar_materi', $m->id_mentor) }}">
        <div class="flip-card p-2 m-2" data-toggle="tooltip" data-placement="top" title="{{ $m->name }}">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img class="rounded" src="{{ url('/images/'.$m->foto) }}" alt="{{ $m->name }}"
...
<script>
    ...
    $(".btn-mentor").on("click", function(){
        ...
        $.ajax({
            type: "get", 
            url: "{{ url('student/data_mentor') }}" + "/" + kode,
            beforeSend: function(){
                $(".proses").show();
            },
                                ...
                                for(var j = 0; j < hasil[0][i]['mp_ke_materi'].length; j++){
                                        ...
                                        $(".box-10-" + hasil[0][i].kode_mentor_pelajaran + "-" + hasil[0][i]['mp_ke_mapel'].kode_mapel).append(
                                            ...
                                            "<div class='col-md-4 mb-4'>" +
                                                ...
                                                "<div class='card'>" +
                                                    "<a href='{{ url('student/materi/read') }}/" + hasil[0][i]['mp_ke_materi'][j]['kode_materi'] +"'><img src='{{ url('images/cover_materi') }}/" + hasil[0][i]['mp_ke_materi'][j]['cover'] +"' class='card-img-top cover-materi' alt='...'></a>" +
                                                    "<div class='card-body'>" +
                            ...
                            for(var j = 0; j < hasil[1][i]['mp_ke_materi'].length; j++){
                                    ...
                                    $(".box-11-" + hasil[1][i].kode_mentor_pelajaran + "-" + hasil[1][i]['mp_ke_mapel'].kode_mapel).append(
                                        ...
                                        "<div class='col-md-4 mb-4'>" +
                                            ...
                                            "<div class='card'>" +
                                                "<a href='javascript:void(0)'><img src='{{ url('images/cover_materi') }}/" + hasil[1][i]['mp_ke_materi'][j]['cover'] +"' class='card-img-top cover-materi' alt='...'></a>" +
                                                "<div class='card-body'>" +
